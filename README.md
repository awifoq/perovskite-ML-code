...
```bibtex
@article{perovskite_temporal_flow,
  title={Efficient Perovskite Solar Cell PCE Prediction and Formulation Optimization
         Based on Temporal Feature Enhancement and Flow Matching Microenvironment},
  author={...},
  year={2025}
}
```
